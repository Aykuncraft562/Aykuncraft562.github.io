...
const page = {
  "Home": () => {
      ...
      <div class="navb-item navb-position">
        ...
        <div class="nitem-selector d-none d-lg-flex">
          ...
          <div class="nitem-ssocial d-none d-lg-flex">
            <button onClick="mdOpen('https://github.com/')"><i class="fa-xl fa-brands fa-github"></i><div class="sunderline"></div></button>
            <button onClick="mdOpen('https://discord.com/')"><i class="fa-xl fa-brands fa-discord"></i><div class="sunderline"></div></button>
            <button onClick="mdOpen('https://wa.me/+6285703060422')"><i class="fa-xl fa-brands fa-whatsapp"></i><div class="sunderline"></div></button>
            <button onCLick="mdOpen('https://www.instagram.com/AykunCraft/')"><i class="fa-xl fa-brands fa-instagram"></i><div class="sunderline"></div></button>
            <button onClick="mdOpen('https://www.youtube.com/@AykunCraft.')"><i class="fa-xl fa-brands fa-youtube"></i><div class="sunderline"></div></button>
          </div>
        </div>
    ...
    pgfun.Add(`<div class="Copyringht">
      <p>Copyright ⒸAykunCraft 2023 <span onClick="mdHref(')"></span> | Made In Indonesia❤️‍🔥</p>
    </div>`)
